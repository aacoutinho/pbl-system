              ...
              <div className="border border-sidebar rounded-md overflow-hidden bg-sidebar-accent">
                ...
                <div className="grid grid-cols-2 divide-x divide-sidebar-accent border-b border-sidebar-accent">
                  ...
                  <div className="px-1 pt-2 pb-0.5">
                    <p className="text-[7px] font-semibold text-gray-400 uppercase tracking-wider leading-none mb-0">Componente</p>
                    <Select
                  ...
                  {/* Semestre */}
                  <div className="px-1 pt-2 pb-0.5">
                    <p className="text-[7px] font-semibold text-gray-400 uppercase tracking-wider leading-none mb-0">Semestre</p>
                    <Select
                ...
                <div className="grid grid-cols-3 divide-x divide-sidebar-accent">
                  ...
                  <div className="px-1 py-0.5">
                    <p className="text-[7px] font-semibold text-gray-400 uppercase tracking-wider leading-none mb-0">Turma</p>
                    <Select
                  ...
                  {/* Problema */}
                  <div className="px-1 py-0.5">
                    <p className="text-[7px] font-semibold text-gray-400 uppercase tracking-wider leading-none mb-0">Problema</p>
                    <Select
                  ...
                  {/* Sessão */}
                  <div className="px-1 py-0.5">
                    <p className="text-[7px] font-semibold text-gray-400 uppercase tracking-wider leading-none mb-0">Sessão</p>
                    <Select
