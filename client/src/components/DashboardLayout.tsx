              ...
              <div className="border border-sidebar rounded-md overflow-hidden bg-sidebar-accent">
                ...
                <div className="grid grid-cols-2 divide-x divide-sidebar-accent border-b border-sidebar-accent">
                  ...
                  <div className="px-1 pt-2 pb-0.5">
                    <p className="text-[9px] font-semibold text-gray-400 uppercase tracking-wider leading-none mb-0">Componente</p>
                    <Select
                    ...
                    >
                      <SelectTrigger className="h-4 w-full text-[11px] font-semibold px-0.5 justify-start gap-0 border-0 shadow-none focus:ring-0 bg-transparent">
                  ...
                  {/* Semestre */}
                  <div className="px-1 pt-2 pb-0.5">
                    <p className="text-[9px] font-semibold text-gray-400 uppercase tracking-wider leading-none mb-0">Semestre</p>
                    <Select
                ...
                <div className="grid grid-cols-3 divide-x divide-sidebar-accent">
                  ...
                  <div className="px-1 py-0.5">
                    <p className="text-[9px] font-semibold text-gray-400 uppercase tracking-wider leading-none mb-0">Turma</p>
                    <Select
                  ...
                  {/* Problema */}
                  <div className="px-1 py-0.5">
                    <p className="text-[9px] font-semibold text-gray-400 uppercase tracking-wider leading-none mb-0">Problema</p>
                    <Select
                  ...
                  {/* Sessão */}
                  <div className="px-1 py-0.5">
                    <p className="text-[9px] font-semibold text-gray-400 uppercase tracking-wider leading-none mb-0">Sessão</p>
                    <Select
